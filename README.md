...
Below is a diagram pointing out the structure of an optical fiber containing a Fiber Bragg Grating structure - the figure displays a refractive index profile and spectral response:
